# 0) PARAMETERS — change n to your extension degree
g = 3
d = g + 1              # = 4
n = 4                  # <— for example, GF(2^3); set this as you like

# 1) SET UP THE FIELD & RING
K = GF(2**n, 'a')      # your even‐characteristic field
R.<x> = PolynomialRing(K)

# 2) ENUMERATE all monic degree-d polys q(x)
all_q = [q for q in R.polynomials(of_degree=d)
            if q.leading_coefficient() == K(1)]
